...
describe('CommentRepository', () => {
  it('should throw Error if methods are invoked', async () => {
    ...
    await expect(commentRepository.likeComment('', '')).rejects.toThrowError('METHOD_NOT_IMPLEMENTED');
    await expect(commentRepository.unlikeComment('', '')).rejects.toThrowError('METHOD_NOT_IMPLEMENTED');
  });
});
